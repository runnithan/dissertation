...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.38\textwidth}
        \centering
        \includegraphics[width=\textwidth]{plots/qq_plot_for_roe.pdf} % Replace with your image path
    \end{minipage}
    \hfill
    % Second image
    \begin{minipage}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{plots/qq_plot_for_sustainability_score.pdf} % Replace with your image path
    \end{minipage}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{plots/roesus.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{images/ridge_lasso_geom.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/mrt_image.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{plots/xgboost_feature_importance.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{plots/forward_stepwise_selection_plot.png}
